...
export const NO_CONFIRM_PASSWORD_MESSAGE: string = "Confirm Password is Required!";
export const PASSWORD_NOT_MATCH_MESSAGE: string = "The two passwords that you entered do not match!";